  ...
  <div class="section3">
    ...
    <div class="containerl">
      ...
      <form action="../controller/request.php" method="post">
        <input type="hidden" name="id_user" id="id_user" value="<?= $sis["id_siswa"] ?>">
        <input type="hidden" name="quest" id="quest" value="<?= $row["id_quest"] ?>">
        <button class="b" type="submit" name="request">Apply Mission</button>
      </form>
    </div>
    <?php endforeach ?>
  </div>
